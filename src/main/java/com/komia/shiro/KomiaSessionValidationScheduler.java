...
public class KomiaSessionValidationScheduler implements SessionValidationScheduler, Runnable {

	@Autowired
    private JdbcTemplate jdbcTemplate;

    /** Private internal log instance. */
    private static final Logger log = LoggerFactory.getLogger(KomiaSessionValidationScheduler.class);
    ...
    public KomiaSessionValidationScheduler() {
        super();
    }
